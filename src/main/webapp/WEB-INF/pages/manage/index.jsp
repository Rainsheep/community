            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        <dd><a lay-href="${pageContext.request.contextPath}/manage/userInfo">基本资料</a></dd>
                        <dd><a lay-href="${pageContext.request.contextPath}/manage/password">修改密码</a></dd>
                        <hr>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <li data-name="component" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="社团活动" lay-direction="2">
                    ...
                    <li data-name="user" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="社团信息" lay-direction="2">
