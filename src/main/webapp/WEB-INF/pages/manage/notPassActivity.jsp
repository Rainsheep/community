    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">被驳回的活动</div>
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="test-table-toolbar-barDemo">
                        ...
                        <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="message">消息</a>
...
<script>
    layui.config({
        ...
        var tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/activity/findNotPassActivityByBelong'
