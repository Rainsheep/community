                ...
                <div class="layui-card-body" pad15>
                    ...
                    <div class="layui-form" lay-filter="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="username" value="${user.aname}" readonly class="layui-input">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="realName" id="realName" value="${user.realName}"
                                       lay-verify="nickname"  autocomplete="off" placeholder="请输入真实姓名" class="layui-input">
                            </div>
                        </div>
...
<script>
    layui.config({
        ...
        form.on("submit(setmyinfo)", function (obj) {
            $.post("${pageContext.request.contextPath}/admin/updateRealName",obj.field,function (res) {
