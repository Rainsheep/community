            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        <dd><a lay-href="${pageContext.request.contextPath}/support/userInfo">基本资料</a></dd>
                        <dd><a lay-href="${pageContext.request.contextPath}/support/password">修改密码</a></dd>
                        <hr>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <li data-name="support" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="${pageContext.request.contextPath}/support/activitySupport">赞助活动</a>
                            </dd>
                        </dl>
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="${pageContext.request.contextPath}/support/supportedActivity">我的赞助</a>
                            </dd>
                        </dl>
                    </li>
